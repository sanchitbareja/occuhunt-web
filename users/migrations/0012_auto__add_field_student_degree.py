...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Student.degree'
        db.add_column(u'users_student', 'degree',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Degree'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Student.degree'
        db.delete_column(u'users_student', 'degree_id')
    ...
    models = {
        ...
        u'users.student': {
            ...
            'degree': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.Degree']", 'null': 'True', 'blank': 'True'}),
