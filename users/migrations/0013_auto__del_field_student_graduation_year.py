...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Student.graduation_year'
        db.delete_column(u'users_student', 'graduation_year')


    def backwards(self, orm):
        # Adding field 'Student.graduation_year'
        db.add_column(u'users_student', 'graduation_year',
