...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Degree'
        db.create_table(u'users_degree', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('degree', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'users', ['Degree'])

        # Adding model 'Major'
        db.create_table(u'users_major', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('major', self.gf('django.db.models.fields.CharField')(max_length=300)),
        ))
        db.send_create_signal(u'users', ['Major'])

        # Adding M2M table for field major on 'Student'
        m2m_table_name = db.shorten_name(u'users_student_major')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('student', models.ForeignKey(orm[u'users.student'], null=False)),
            ('major', models.ForeignKey(orm[u'users.major'], null=False))
        ))
        db.create_unique(m2m_table_name, ['student_id', 'major_id'])

        # Adding M2M table for field degree on 'Student'
        m2m_table_name = db.shorten_name(u'users_student_degree')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('student', models.ForeignKey(orm[u'users.student'], null=False)),
            ('degree', models.ForeignKey(orm[u'users.degree'], null=False))
        ))
        db.create_unique(m2m_table_name, ['student_id', 'degree_id'])


    def backwards(self, orm):
        # Deleting model 'Degree'
        db.delete_table(u'users_degree')

        # Deleting model 'Major'
        db.delete_table(u'users_major')

        # Removing M2M table for field major on 'Student'
        db.delete_table(db.shorten_name(u'users_student_major'))

        # Removing M2M table for field degree on 'Student'
        db.delete_table(db.shorten_name(u'users_student_degree'))
    ...
    models = {
        ...
        u'users.degree': {
            ...
            'degree': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'users.major': {
            'Meta': {'object_name': 'Major'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'major': ('django.db.models.fields.CharField', [], {'max_length': '300'})
        },
        u'users.recruiter': {
        ...
        u'users.student': {
            ...
            'degree': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['users.Degree']", 'symmetrical': 'False'}),
            'graduation_year': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'major': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['users.Major']", 'symmetrical': 'False'}),
            u'user_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['users.User']", 'unique': 'True', 'primary_key': 'True'}),
            'verified_email': ('django.db.models.fields.EmailField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'})
        },
        u'users.user': {
