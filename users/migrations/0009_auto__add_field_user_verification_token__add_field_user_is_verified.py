...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.verification_token'
        db.add_column(u'users_user', 'verification_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'User.is_verified'
        db.add_column(u'users_user', 'is_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.verification_token'
        db.delete_column(u'users_user', 'verification_token')

        # Deleting field 'User.is_verified'
        db.delete_column(u'users_user', 'is_verified')
