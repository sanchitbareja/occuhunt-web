...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Student.verified_email'
        db.alter_column(u'users_student', 'verified_email', self.gf('django.db.models.fields.EmailField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'Student.verified_email'
        db.alter_column(u'users_student', 'verified_email', self.gf('django.db.models.fields.EmailField')(max_length=22, null=True))
