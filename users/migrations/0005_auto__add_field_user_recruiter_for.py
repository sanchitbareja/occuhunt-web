...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.recruiter_for'
        db.add_column(u'users_user', 'recruiter_for',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['companies.Company'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.recruiter_for'
        db.delete_column(u'users_user', 'recruiter_for_id')
