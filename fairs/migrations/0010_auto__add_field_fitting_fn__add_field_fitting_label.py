...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Fitting.fn'
        db.add_column(u'fairs_fitting', 'fn',
                      self.gf('django.db.models.fields.PositiveIntegerField')(max_length=512, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Fitting.label'
        db.add_column(u'fairs_fitting', 'label',
                      self.gf('django.db.models.fields.PositiveIntegerField')(max_length=512, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Fitting.fn'
        db.delete_column(u'fairs_fitting', 'fn')

        # Deleting field 'Fitting.label'
        db.delete_column(u'fairs_fitting', 'label')
