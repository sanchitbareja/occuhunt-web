...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # for each fair
        # create an associated event and save it
        # associate the event and fair
        for fair in orm.Fair.objects.all():
            new_event = orm.Event(name=fair.name, time_start=fair.time_start, time_end=fair.time_end)
            new_event.save()
            fair.event = new_event
            fair.save()
