...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fairs_location', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('lat', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5, blank=True)),
            ('lng', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=5, blank=True)),
        ))
        db.send_create_signal(u'fairs', ['Location'])

        # Adding field 'Event.thumbnail'
        db.add_column(u'fairs_event', 'thumbnail',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'fairs_location')

        # Deleting field 'Event.thumbnail'
        db.delete_column(u'fairs_event', 'thumbnail')
