...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ThreeFiveSeven.fair'
        db.alter_column(u'fairs_threefiveseven', 'fair_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['fairs.Fair']))
        # Adding unique constraint on 'ThreeFiveSeven', fields ['fair']
        db.create_unique(u'fairs_threefiveseven', ['fair_id'])


        # Changing field 'Infosession.fair'
        db.alter_column(u'fairs_infosession', 'fair_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['fairs.Fair']))
        # Adding unique constraint on 'Infosession', fields ['fair']
        db.create_unique(u'fairs_infosession', ['fair_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Infosession', fields ['fair']
        db.delete_unique(u'fairs_infosession', ['fair_id'])

        # Removing unique constraint on 'ThreeFiveSeven', fields ['fair']
        db.delete_unique(u'fairs_threefiveseven', ['fair_id'])


        # Changing field 'ThreeFiveSeven.fair'
        db.alter_column(u'fairs_threefiveseven', 'fair_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fairs.Fair']))

        # Changing field 'Infosession.fair'
        db.alter_column(u'fairs_infosession', 'fair_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fairs.Fair']))
