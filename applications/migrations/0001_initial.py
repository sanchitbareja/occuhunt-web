...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'applications_application', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='candidate', to=orm['users.User'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['companies.Company'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=512)),
    ...
    models = {
        u'applications.application': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'candidate'", 'to': u"orm['users.User']"})
        },
        u'applications.note': {
