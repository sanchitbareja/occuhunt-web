...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.student_note'
        db.add_column(u'applications_application', 'student_note',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.student_note'
        db.delete_column(u'applications_application', 'student_note')
