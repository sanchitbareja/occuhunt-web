...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field documents on 'Application'
        m2m_table_name = db.shorten_name(u'applications_application_documents')
        ...
        db.create_unique(m2m_table_name, ['application_id', 'document_id'])


    def backwards(self, orm):
        # Removing M2M table for field documents on 'Application'
        db.delete_table(db.shorten_name(u'applications_application_documents'))
