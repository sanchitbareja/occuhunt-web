...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ApplicationTracking'
        db.create_table(u'applications_applicationtracking', (
            ...
            ('added_by_user', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'applications', ['ApplicationTracking'])

        # Adding model 'ApplicationDocument'
        db.create_table(u'applications_applicationdocument', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'applications', ['ApplicationDocument'])

        # Adding field 'Application.application_status'
        db.add_column(u'applications_application', 'application_status',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['applications.ApplicationTracking'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ApplicationTracking'
        db.delete_table(u'applications_applicationtracking')

        # Deleting model 'ApplicationDocument'
        db.delete_table(u'applications_applicationdocument')

        # Deleting field 'Application.application_status'
        db.delete_column(u'applications_application', 'application_status_id')
