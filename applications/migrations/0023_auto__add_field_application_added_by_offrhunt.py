...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.added_by_offrhunt'
        db.add_column(u'applications_application', 'added_by_offrhunt',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.added_by_offrhunt'
        db.delete_column(u'applications_application', 'added_by_offrhunt')
