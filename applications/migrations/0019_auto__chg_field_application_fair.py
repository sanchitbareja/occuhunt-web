...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Application.fair'
        db.alter_column(u'applications_application', 'fair_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fairs.Fair'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Application.fair'
        raise RuntimeError("Cannot reverse this migration. 'Application.fair' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Application.fair'
        db.alter_column(u'applications_application', 'fair_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fairs.Fair']))
