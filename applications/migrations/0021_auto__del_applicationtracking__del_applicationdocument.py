...
class Migration(SchemaMigration):
    ...
    models = {
        u'applications.application': {
            ...
            'documents': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['documents.Document']", 'null': 'True', 'symmetrical': 'False'}),
            'fair': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fairs.Fair']", 'null': 'True'}),
