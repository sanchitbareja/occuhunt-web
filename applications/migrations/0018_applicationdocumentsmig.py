...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # 1. for each application, get documents
        # 2. add documents to applications__documents m2m field
        for app in orm['applications.Application'].objects.all():
            # 1. get documents
            documents = orm['applications.applicationdocument'].objects.filter(application=app)
            for doc in documents:
                app.documents.add(doc.document)
            app.save()
