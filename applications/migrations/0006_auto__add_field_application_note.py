...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.note'
        db.add_column(u'applications_application', 'note',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.note'
        db.delete_column(u'applications_application', 'note')
