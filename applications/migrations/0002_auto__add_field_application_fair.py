...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.fair'
        db.add_column(u'applications_application', 'fair',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['fairs.Fair']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.fair'
        db.delete_column(u'applications_application', 'fair_id')
    ...
    models = {
        u'applications.application': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'Applied'", 'max_length': '512'}),
