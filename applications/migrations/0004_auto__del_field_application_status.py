...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'applications_application', 'status')


    def backwards(self, orm):
        # Adding field 'Application.status'
        db.add_column(u'applications_application', 'status',
                      self.gf('django.db.models.fields.CharField')(default='Applied', max_length=512),
                      keep_default=False)
