...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Application.recruiter_email'
        db.delete_column(u'applications_application', 'recruiter_email')

        # Adding field 'Application.recruiter_contact'
        db.add_column(u'applications_application', 'recruiter_contact',
                      self.gf('django.db.models.fields.EmailField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Application.recruiter_message'
        db.add_column(u'applications_application', 'recruiter_message',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Application.recruiter_email'
        db.add_column(u'applications_application', 'recruiter_email',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Deleting field 'Application.recruiter_contact'
        db.delete_column(u'applications_application', 'recruiter_contact')

        # Deleting field 'Application.recruiter_message'
        db.delete_column(u'applications_application', 'recruiter_message')
    ...
    models = {
        u'applications.application': {
            ...
            'recruiter_contact': ('django.db.models.fields.EmailField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
