...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.reason_given'
        db.add_column(u'applications_application', 'reason_given',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.reason_given'
        db.delete_column(u'applications_application', 'reason_given')


    models = {
        u'applications.application': {
            'Meta': {'object_name': 'Application'},
            'added_by_offrhunt': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'reason_given': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'student_note': ('django.db.models.fields.TextField', [], {'default': "''", 'blank': 'True'}),
