...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.response_timestamp'
        db.add_column(u'applications_application', 'response_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.response_timestamp'
        db.delete_column(u'applications_application', 'response_timestamp')
