...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'documents_document', (
            ...
            ('document_type', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('image_url', self.gf('django.db.models.fields.URLField')(max_length=1000)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=1000)),
            ('unique_hash', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
        ...
        # Adding model 'Link'
        db.create_table(u'documents_link', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.User'])),
            ('link_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=1000)),
            ('delete', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'documents', ['Link'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Link'
        db.delete_table(u'documents_link')
