...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visit.document'
        db.add_column(u'documents_visit', 'document',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documents.Document'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Visit.link'
        db.add_column(u'documents_visit', 'link',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documents.Link'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visit.document'
        db.delete_column(u'documents_visit', 'document_id')

        # Deleting field 'Visit.link'
        db.delete_column(u'documents_visit', 'link_id')
