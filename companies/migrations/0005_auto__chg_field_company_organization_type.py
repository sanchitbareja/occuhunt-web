...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Company.organization_type'
        db.alter_column(u'companies_company', 'organization_type', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'Company.organization_type'
        db.alter_column(u'companies_company', 'organization_type', self.gf('django.db.models.fields.TextField')(null=True))
