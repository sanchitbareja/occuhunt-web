...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.qualifications'
        db.add_column(u'jobs_job', 'qualifications',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Job.timestamp'
        db.add_column(u'jobs_job', 'timestamp',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Job.qualifications'
        db.delete_column(u'jobs_job', 'qualifications')

        # Deleting field 'Job.timestamp'
        db.delete_column(u'jobs_job', 'timestamp')
