...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Offer.offer_deadline_timestamp'
        db.add_column(u'offers_offer', 'offer_deadline_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 8, 11, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Offer.offer_deadline_timestamp'
        db.delete_column(u'offers_offer', 'offer_deadline_timestamp')
    ...
    models = {
        ...
        u'offers.offer': {
            ...
            'offer_deadline_timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
