...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'notifications_notification', 'receiver',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'notifications_notification', 'receiver')
    ...
    models = {
        ...
        u'notifications.notification': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notification': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
            'read_receipt': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'receiver': ('django.db.models.fields.SmallIntegerField', [], {'default': '1'}),
